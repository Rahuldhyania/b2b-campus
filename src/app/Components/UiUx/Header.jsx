...
import arrowdown from "../../../../public/images/arrowdown.webp";
...
const coursesData = {
    Logistics: [
        { name: "Truck Dispatch", path: "/truckdispatcher" },
    ...
    return (
        <nav className="relative z-50">
            ...
            {megaOpen && (
                ...
                rounded-xl p-4 z-50 flex flex-col md:flex-row w-[95%] max-w-[1200px] gap-4 overflow-hidden
            "
                    >
                        ...
                        {/* LEFT SIDEBAR */}
                        <div className="md:w-1/4 w-full md:border-r pr-4 mb-4 md:mb-0">
                        ...
                        <div className="md:w-3/4 w-full py-3 md:px-6 overflow-y-auto h-full">
                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                                ...
                                "
                                        >
                                            <div className="p-2">
                                                <p className="text-[#5D38DE] font-semibold text-[13px]">
                                                    {course.name}
                                                </p>
                                            </div>

                                            <div className="px-2 pb-2 text-[12px] text-gray-600 leading-tight">
                                                <span className="text-[#5D38DE] mt-1 inline-block text-[12px]">
                                                    View course →
                                                </span>
                                            </div>
                                        </motion.div>
