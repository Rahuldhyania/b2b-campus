...
export const Newletterfrom = () => {
  ...
  const handleSubmit = async () => {
    ...
    const payload = {
      __vtrftk: "sid:c8df06e6795d3983c0e30b0eda2ce9c6c6db3906,1765291193",
      publicid: "266ab7e2196cdb634e4e2ac84b815c33",
      urlencodeenable: "1",
    ...
    <div>
      <div className="flex flex-col md:flex-row items-center md:items-end gap-5">
        ...
        <button
          ...
          className="bg-white text-[#5D38DE] px-6 sm:px-10 py-3 text-[16px] sm:text-[18px] rounded-2xl transition-all hover:bg-[#f3efff]"
        >
          Submit
        </button>
      </div>
