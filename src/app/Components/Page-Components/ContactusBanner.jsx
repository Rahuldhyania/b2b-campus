                            ...
                            <div className='pt-10 space-y-4'>
                                <div>
                                    <p className='flex items-center gap-1 text-2xl'>
                                        ...
                                        Phone : <span className='mx-3'> <a href="tel:+919878300209" target='_blank'>+91 98783-00209</a>,  <a href="+918360116967" target='_blank'>+91 83601-16967</a></span>
                                    </p>
                                </div>
                                <div>
                                    <p className='flex items-center gap-1 text-2xl'>
                                ...
                                <div>
                                    <p className='flex items-center gap-1 text-2xl'>
                                        ...
                                        Whatsapp : <span className='mx-3'> <a href="https://wa.me/9878300209" target='_blank' className='text-green-800 underline'>+91 98783-00209</a></span>
                                    </p>
                                </div>
                                <div>
                                    <p className='flex items-start gap-1 text-2xl whitespace-nowrap'>
                                        ...
                                        Address : <span className='mx-3 whitespace-normal'>
                                            <a href="https://goo.gl/maps/T97ciccSwQPX5eg47" target='_blank' className='text-black underline'>F-209, Industrial area Phase 8-B, Sector 74, <br /> Mohali, 160074</a>
                                        </span>
                                    </p>
                                </div>
                            </div>
